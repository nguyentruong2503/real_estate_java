    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-600 px-6 py-4 flex items-center justify-between">
            <h1 class="text-2xl font-bold text-white">
                <i class="fas fa-building mr-2"></i> Cập nhật thông tin cá nhân
            </h1>
        ...
        <form:form class="p-6" modelAttribute="userEdit" id="listForm" method="POST">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <form:hidden path="roleCode" id="roleCode"></form:hidden>
                    <div>
                        <label
    ...
    function addOrUpdateUser(data){
        $.ajax({
            ...
            success: function (respond) {
                ...
                window.location.href = "/admin/user/profile-" +data.id;
            },
